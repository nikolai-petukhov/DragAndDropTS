...
define("state/project-state", ["require", "exports", "models/project"], function (require, exports, project_1) {
    ...
    class ProjectState extends State {
        ...
        addProject(title, description, numbOfPeople) {
            const newProject = new project_1.Project(Math.random.toString(), title, description, numbOfPeople, project_1.ProjectStatus.Active);
...
define("components/project-list", ["require", "exports", "components/base-component", "models/project", "decorators/autobind", "state/project-state", "components/project-item"], function (require, exports, base_component_3, project_2, autobind_3, project_state_2, project_item_1) {
    ...
    __decorate([
        autobind_3.autobind
    ], ProjectList.prototype, "dragOverHadler", null);
    __decorate([
        autobind_3.autobind
    ], ProjectList.prototype, "dragLeaveHadler", null);
    __decorate([
        autobind_3.autobind
    ], ProjectList.prototype, "dropHadler", null);
